...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Pembobotan Kriteria Kompetensi</h1>
	</div>
</div><!--/.row-->
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">Matriks Perbandingan Kriteria Kompetensi</div>
			<div class="panel-body">
				...
				<table class="display" id="table-style" cellspacing="0" width="100%" border="1">
				    ...
				    <tbody>
				    	...
				    	<?php 
				    		$cek = $this->db->query('SELECT * FROM matriks_perbandingan_kriteria WHERE mpkUserId = '.$userId);
				    			if ($cek->num_rows() > 0) {
				    	?>
				    	...
				    	<?php
				    		for ($i=0; $i < count($matriks); $i++) { 
				    			$explode = $matriks[$i];	
				    			$nilai = $this->db->query('SELECT * FROM matriks_perbandingan_kriteria WHERE mpkUserId = '.$userId.' AND mpkKriteriaIdBaris = '.$matriksPosisi[$i])->row()->mpkNilai;			    			
				    	?>
				    	<tr>
				    		<td><?php echo getKriteria($explode[0],'kriteriaNama'); ?></td>
				    		...
				    		<td><?php echo getKriteria($explode[1],'kriteriaNama'); ?></td>
				    	</tr>
				    	<?php
				    		}
				    	?>
