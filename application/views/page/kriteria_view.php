	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div>
					<a href="<?php echo site_url('home/kriteriaTambah') ?>"><img src="<?php echo base_url() ?>assets/images/add_files.png" height="48px"><strong>Tambah Kriteria</strong></a>
				</div>
				<br />
			        ...
			        <tbody>
			        	<?php $i=1; foreach ($list->result() as $value) { ?>
			        		<tr>
			        			...
			        			<td><?php echo $value->kriteriaKeterangan ?></td>
			        			<td>
			        				<a href="<?php echo site_url('home/kriteriaEdit/'.$value->kriteriaId) ?>" ><img src="<?php echo base_url() ?>assets/images/edit.png" height="24px"></a>
			        				<a href="<?php echo site_url('home/kriteriaHapus/'.$value->kriteriaId) ?>" onClick="return confirm('yakin data akan dihapus?')"><img src="<?php echo base_url() ?>assets/images/trash-bin-open.png" height="24px"></a>
			        			</td>
			        		</tr>
			        	<?php } ?>
			        </tbody>
