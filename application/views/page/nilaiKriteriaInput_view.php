...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Input Nilai Kriteria Alternatif Karyawan</h1>
	</div>
</div><!--/.row-->
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Input Data Nilai Kriteria Alternatif Karyawan</div>
			        ...
			        <tbody>
			        	<?php $i=1; foreach ($kriteria->result() as $value) { ?>
			        		<tr>
			        			...
			        			<td>
			        				<input class="form-control" name="kriteria_<?php echo $value->kriteriaId ?>" required="">
			        			</td>			        			
			        		</tr>
			        	<?php } ?>
			        </tbody>
