...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Pembobotan DM</h1>
	</div>
</div><!--/.row-->
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">Matriks Perbandingan DM</div>
			<div class="panel-body">
				...
				<table class="display" id="table-style" cellspacing="0" width="100%" border="1">
				    ...
				    <form action="<?php echo site_url('dm/cekKonsistensi') ?>" method="post">
				    <tbody>

				    	<?php 
				    		$cek = $this->db->query('SELECT * FROM matriks_perbandingan_dm');
				    			if ($cek->num_rows() > 0) {
				    	?>
				    	...
				    	<?php
				    		for ($i=0; $i < count($matriks); $i++) { 
				    			...
				    			$tengah = $panjang/2;
				    			$sisip = substr_replace($matriks[$i],'_',floor($tengah),0);
				    			$explode = explode('_', $sisip);	
				    			$nilai = $this->db->query('SELECT * FROM matriks_perbandingan_dm WHERE mpdDmBaris = '.$matriksPosisi[$i])->row()->mpdNilai;			    			
				    	?>
				    	<tr>
				    		<td><?php echo getUser($explode[0],'nama'); ?></td>
				    		...
				    		<td><?php echo getUser($explode[1],'nama'); ?></td>
				    	</tr>
				    	<?php
				    		}
				    	?>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">Hasil Bobot DM Dari Matriks Perbandingan Di Atas</div>
			<div class="panel-body">
				<table class="display" id="table-style" cellspacing="0" width="100%" border="1">
				    <thead>
					    <tr>
