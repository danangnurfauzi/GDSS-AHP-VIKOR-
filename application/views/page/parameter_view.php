	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div>
					<a href="<?php echo site_url('home/parameterTambah') ?>"><img src="<?php echo base_url() ?>assets/images/add_files.png" height="48px"><strong>Tambah Sub kriteria</strong></a>
				</div>
				<br />
			        ...
			        <tbody>
			        	<?php $i=1; foreach ($list->result() as $value) { ?>
			        		<tr>
			        			...
			        			<td><?php echo $value->parameterKeterangan ?></td>
			        			<td>
			        				<a href="<?php echo site_url('home/parameterEdit/'.$value->parameterId) ?>" ><img src="<?php echo base_url() ?>assets/images/edit.png" height="24px"></a>
			        				<a href="<?php echo site_url('home/parameterHapus/'.$value->parameterId) ?>" onClick="return confirm('yakin data akan dihapus?')"><img src="<?php echo base_url() ?>assets/images/trash-bin-open.png" height="24px"></a>
			        			</td>
			        		</tr>
			        	<?php } ?>
			        </tbody>
